defmodule HabitWaveWebWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {HabitWaveWebWeb.Layouts, :root}
  ...
  # scope "/api", HabitWaveWebWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:habit_wave_web, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: HabitWaveWebWeb.Telemetry
